...
def create_test_zip(
    directory: Path, filename: str = "test.zip", content: str = "test content"
) -> Path:
...
def create_test_7z(
    directory: Path, filename: str = "test.7z", content: str = "test content"
) -> Path:
...
def create_test_tar_gz(
    directory: Path, filename: str = "test.tar.gz", content: str = "test content"
) -> Path:
...
def create_test_tgz(
    directory: Path, filename: str = "test.tgz", content: str = "test content"
) -> Path:
