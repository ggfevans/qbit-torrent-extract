...
def config_console_only():
    ...
    return Config(log_dir=None, per_torrent_logs=False, log_level="INFO")
...
class TestTorrentLogManager:
    ...
    def test_sanitize_filename(self, config_with_logging):
        ...
        assert (
            manager._sanitize_filename("torrent/with\\slashes")
            == "torrent_with_slashes"
        )
        assert (
            manager._sanitize_filename("torrent:with|special?chars*")
            == "torrent_with_special_chars"
        )
...
class TestIntegrationWithExtractor:
    ...
    def test_extractor_with_torrent_logging(self, config_with_logging):
        ...
        extractor = ArchiveExtractor(
            config=config_with_logging, torrent_name="Integration Test"
        )
