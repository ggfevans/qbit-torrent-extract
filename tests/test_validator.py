...
class TestArchiveValidator:
    ...
    def create_test_zip(self, path: Path, files: dict, compression=zipfile.ZIP_DEFLATED):
    ...
    def test_validate_valid_zip(self, validator, temp_dir):
        ...
        self.create_test_zip(zip_path, {
            "file1.txt": "Hello World" * 10,
            "file2.txt": "Test content" * 10
        })
    ...
    def test_scan_directory(self, validator, temp_dir):
        ...
        nested_dir.mkdir()
        self.create_test_zip(nested_dir / "nested.zip", {"nested.txt": "nested content"})
